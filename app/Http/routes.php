...
*/
    ...
    */
     ...
     * Location CRUD.
     */
    Route::resource('location', 'Location', ['only' => [
        'show', 'edit', 'update','destroy'
    ]]);
    ...
    */
    ...
    /**
     *  Routes related to all map's locations
     */

    /*Route::get('/myLocations', function(){return view('myLocations');});*/
    Route::get('/myLocations','Location@locations');
    Route::post('myLocations/search', 'Location@search');

    Route::resource('/myLocations/{id}/show','Location@show');
    Route::resource('/myLocations/{id}/edit', 'Location@edit');
    

    Route::get('/addLocation', function(){

        return view('addLocation');});
    Route::post('addLocation/store', 'addLocation@store');

    

    Route::get('/manpower/request', function(){
        return view('manpowerRequest');});
    Route::post('manpower/request', 'manpowerController@request');

    Route::get('/fundraising/request', function(){
        return view('fundraisingRequest');});
    Route::post('fundraising/request', 'fundraisingController@request');    
    
    Route::get('/partnership/request', function(){
            return view('partnershipRequest');});
    Route::post('/partnership/request', 'partnershipController@request');  
 /**
     *  Routes related to administrator
     */

    Route::get('/ke-admin', function(){
