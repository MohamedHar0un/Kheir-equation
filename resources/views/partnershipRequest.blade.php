    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">Partnership Request</div>

                <div class="panel-body">
                <div class="container">Fill the form below<br></div>
                </div>
                <div class="panel-body">
                     <form class="form" class="form-control" action="{{ url('partnership/request') }}" files="true" value="PATCH" role="form" method="POST">
                {!! csrf_field() !!}
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control input-sm" name="individuals_effected_number" required="true"></input>
                    </div>
                    
                    
                     <div class="form-group">
                        <label for="">Area Of Partnership</label>
                        <input type="text" class="form-control input-sm" name="Area_of_partnership"></input>
                    </div>
